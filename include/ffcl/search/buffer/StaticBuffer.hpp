...
class StaticBuffer {
  public:
    ...
    static_assert(common::is_crtp_of<BoundType, datastruct::bounds::StaticBoundWithCentroid>::value,
                  "BoundType does not inherit from datastruct::bounds::StaticBoundWithCentroid<Derived>");
    ...
    void update(const IndexType&             index_candidate,
                ...
                std::optional<OptionalType>& optional_parameter) {
        static_base_traits<DerivedBuffer>::call_update(static_cast<DerivedBuffer*>(this),
                                                       /**/ index_candidate,
                                                       /**/ distance_candidate,
                                                       /**/ optional_parameter);
