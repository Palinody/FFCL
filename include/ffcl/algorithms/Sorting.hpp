...
std::size_t partition_around_nth_index(const IndicesIterator& indices_range_first,
    ...
    while (true) {
        ...
        */
        ...
        if (common::utils::inequality(
                pivot_value, samples_range_first[indices_range_first[right_index] * n_features + feature_index])) {
        ...
        // the values at the pivot and the right index are equal
            ...
            if (common::utils::equality(
                    samples_range_first[indices_range_first[left_index] * n_features + feature_index], pivot_value)) {
