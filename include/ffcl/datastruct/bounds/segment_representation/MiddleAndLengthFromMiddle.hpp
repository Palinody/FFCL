...
class MiddleAndLengthFromMiddle : public StaticSegmentRepresentation<MiddleAndLengthFromMiddle<Value>> {
  public:
    ...
    MiddleAndLengthFromMiddle(const SegmentType& segment_representation)
      : segment_representation_{segment_representation} {}

    MiddleAndLengthFromMiddle(SegmentType&& segment_representation) noexcept
