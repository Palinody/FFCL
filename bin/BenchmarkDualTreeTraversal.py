...
split_index_path = root_folder + "split_index.txt"
brute_force_time_path = root_folder + "brute_force_time.txt"
dual_tree_search_time_path = root_folder + "dual_tree_search_time.txt"
